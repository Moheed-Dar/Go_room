        ...
        <>
            <div className='grid grid-cols-1 lg:grid-cols-2 mt-30 gap-6'>
                <div className='ms-8 p-2'>
                    ...
                    <br />
                    <form>
                        <input className='border mb-5 placeholder:ps-4 ms-2 w-full md:w-[80%] h-12' placeholder='Select Country' type="text" /><br />
                        <input className='border h-12 placeholder:ps-4 w-full md:w-[80%] ms-2' placeholder='Select City' type="text" /><br />
                        <button className='bg-black h-12 mt-8 px-4 ms-2 gap-3 text-white'>Find Hotel <span>→</span></button>
                    </form>
                </div>

                <div className='hidden lg:grid grid-cols-2 gap-5 p-5'>
                    <div className='pt-2'>
